...
#Preview("Compact Header - Attendee") {
    CompactProfileHeader(
        user: User(
            ...
            isOrganizer: false,
            hasBothRoles: false,
            needsVerificationForOrganizerActions: false,
...
#Preview("Compact Header - Organizer") {
    VStack(spacing: 20) {
        CompactProfileHeader(
            user: User(
                id: UUID(),
