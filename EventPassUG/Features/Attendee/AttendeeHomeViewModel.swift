...
class AttendeeHomeViewModel: ObservableObject {
    ...
    private(set) var eventService: EventRepositoryProtocol
    ...
    init(eventService: EventRepositoryProtocol) {
    ...
    func updateEventService(_ service: EventRepositoryProtocol) {
